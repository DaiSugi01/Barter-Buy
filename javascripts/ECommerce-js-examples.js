let products = {
  ...
  getProductByID: function(productID) {
    ...
    if (!this.hasOwnProperty(productID)) {
      return `There is no ${productID} in products.`
    } else {
      const name = products[productID]["name"];
      const price = products[productID]["price"];
      const description = products[productID]["description"];
  ...
  getProductByName: function(productName) {
     // should return a sentence containing all of the info about the product (name price, and description)
      ...
      return `There is no ${productName} in products.`
  },
  ...
  addProduct: function(name, price, desc) {
    ...
    return products.getProductByID(uid)
  },
...
// console.log(products.addProduct("name1", 99999, "This is a description"));
